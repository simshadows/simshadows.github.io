...
<table class="general">
    ...
    <tbody>
        <tr>
            <td><Latex code="\text{Push}\parens{\textit{item}}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
            <td>Add a single item.</td>
        </tr>
        <tr>
            <td><Latex code="\text{Pop}\parens{} \to \textit{item}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
        ...
        <tr>
            <td><Latex code="\text{Push-Pop}\parens{\textit{item}} \to \textit{item}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
        ...
        <tr>
            <td><Latex code="\text{Pop-Push}\parens{\textit{item}} \to \textit{item}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
        ...
        <tr>
            <td><Latex code="\text{Heapify}\parens{}" /></td>
            <td><Latex code="O\parens{n}" /></td>
            <td>Convert an arbitrary <em>complete binary tree</em> into a valid heap.</td>
        </tr>
        <tr>
            <td><Latex code="\text{Get-Size}\parens{} \to \textit{size}" /></td>
            <td><Latex code="O\parens{1}" /></td>
            <td>Get the number of items in the heap.</td>
        </tr>
        <tr>
            <td>(internal) <Latex code="\text{Sift-Up}\parens{\textit{node}}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
            <td>Moves a node up the tree until it is in a valid position.</td>
        </tr>
        <tr>
            <td>(internal) <Latex code="\text{Sift-Down}\parens{\textit{node}}" /></td>
            <td><Latex code="O\parens{\log n}" /></td>
