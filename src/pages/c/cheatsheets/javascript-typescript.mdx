...
class MyClass1 {
    ...
    static #myPrivateStaticField = 456;
    ...
    myMethod() {
        return this.#myPrivateField + this.#myPrivateMethod();
    }
    #myPrivateMethod() {
...
const obj = new MyClass1(3, 5);
obj.constructor.name // Returns the object's class name
MyClass1.name        // Returns the class's name
```
