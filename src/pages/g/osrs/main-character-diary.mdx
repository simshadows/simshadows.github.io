...
import ValveGrayCodes from "_main-character-diary.ValveGrayCodes";
...
### 2026-01-24 Quest: Hazeel Cult

By chance, I chose to help the Hazeel cult while my friend chose to join them. Unfortunately, that meant I got no hint for the valves puzzle while my friend got a hint, though even when they shared the hint, we couldn't figure out what it meant. I solved the puzzle by brute forcing all the possible valve combinations using [Gray Code](https://en.wikipedia.org/wiki/Gray_code) because it minimizes the amount of work I need to do to change the valves between tries at the raft.

I started by indexing the valves:

![A starry night sky.](./_images/hazeel-cult-valves.png)

Then I found a codes table and I basically translated it into this:

<ValveGrayCodes/>

and I went and did all combinations until I could get to the end. I got to the end at attempt 8.

I don't know how you're meant to figure that out. Brute force seems quite unreasonable.

My chosen path through the quest resulted in the dog surviving while my friend's dog died, so it has become a bit of a running joke now that ever time we pass by the house, I pet the dog.

### 2026-01-24 Quests

Quests completed:

- <Quest name="Sheep Herder"/>
- <Quest name="Biohazard"/>

### 2026-02-03 Quest: Merlin's Crystal

Oh my god this quest was a massive pain in the ass. Everything about this quest was straightforward, except for the chaos altar and the lady of the lake.

We originally tried the altar south-west of Ardougne and the two just north of Falador, but nothing. We looked up a list of chaos altars on the wiki because all the chaos altars we knew off off by heart had no magic words. The very first chaos altar from the wiki that I tried was the south-east Varrock one, which had the words.

The lady of the lake was a massive pain in the ass that took literally several days, and many actual hours of manually searching all over the place to find any sort of clue. I even spent some hours exploring using the mobile client while I was riding on public transport in real life. We tried running around the bodies of water nearby Camelot, though our attention was particularly drawn to the one just north of Camelot which had the island with the boat in it.

We must've walked around all these nearby waters like 10 times now, talked to all the NPCs in Seers Village and Catherby several times, and explored as far as Ardougne, all with no luck. Then we decided to try looking at other bodies of water further away. While I was making my way around the bodies of water on my way to Baxtorian Falls, my friend started by going to Taverley to the lake below it and immediately found the lady of the lake.

This quest was so dumb. We wasted so many hours because the game gave no good clues. We assumed (IMO quite reasonably) that the first real hint to find the lady of the lake would be nearby Camelot, which was why we tunnel-visioned and only really explored nearby it. So terribly frustrating.

### 2026-02-14 Quest: Murder Mystery

Me and my friend noticed quite early that we got different dialogue when checking what items around the house are poisoned.

My friend got the fingerprint hint from Gossip quite early on. They "spoiled" me on that hint, so I went to Gossip and kept on asking Gossip to give me a hint. I spent maybe 10 minutes just asking Gossip for a hint before he would tell me about the fingerprints thing.

### 2026-02-15 Quest: Priest in Peril

Quest complete!

### 2026-02-15 Quest: Nature Spirit

We tried all sorts of things before eventually realizing that the spell is the item from the spirit-to-be freely given, and from Priest in Peril, we are the something of faith and we had to stand on top of the faith rock! That was a really fun one to figure out.

### 2026-02-16 Quest: Twilight's Promise

Quest complete!

### 2026-02-18 Quest: Making History

Quest complete!

### 2026-02-22

I started Mage Training Arena, and I ended the day having obtained Bones to Peaches and Rune Pouch!
...
- <Quest name="The Golem"/>

### 2026-05-12 Quest: Lost City

Quest complete!

### 2026-05-13 Quest: Fairytale I - Growing Pains

Quest complete!

### 2026-05-20 Quest: The Dig Site

Quest complete!

### 2026-05-20

I started Fairytale II, and got to the point where I've unlocked fairy rings. Putting the quest on hold until it can be completed.

### 2026-05-21 Quest: Jungle Potion

Quest complete!

### Quest In Progress: Tribal Totem

We're completely stuck on this quest right now because we don't know how to get inside the mansion. There are no clues!

## Stuff I want to try in the future

- Can you still use the blueprint from *The Tourist Trap*?
- Can we give ghe stone tablet back to Terry in the exam center?
